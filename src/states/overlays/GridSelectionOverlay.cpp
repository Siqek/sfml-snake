    ...
    GridHoleSizeSelectorLabel("Hole Size", font)
{
    ...
    const auto setSelectorColors = [](auto& selector) -> void {
    ...
    setSelectorColors(GridSelector);
    setSelectorColors(GridSizeSelector);
    setSelectorColors(GridHoleSizeSelector);
...
{
    const sf::Vector2f backgroundSize = sf::Vector2f(windowSize.x * 0.3f, windowSize.y * 0.9f);
    const float outlineThickness = backgroundSize.x / 128.f;

    GridSelectionBackground.setPosition(windowSize / 2.f);
    ...
    GridImitation.setPosition(sf::Vector2f(windowSize.x / 2.f, windowSize.y / 2.f - backgroundSize.y / 2.f + gridImitationSideSize / 2.f + gridImitationYMargin));
    ...
    GridSelector.setPosition(sf::Vector2f(windowSize.x / 2.f, windowSize.y / 2.f + backgroundSize.y / 2.f - selectorSize.y));
    ...
    const sf::Vector2f gridSizeSelectorLabelPosition = windowSize / 2.f + sf::Vector2f(0, subselectorSize.y / 2.f + subselectorYMargin + subselectorYGapToLabel);
